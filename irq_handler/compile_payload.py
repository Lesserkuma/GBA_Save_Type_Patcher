...
def embed(data_file: Path, payload: bytes, symbols: dict[str, int]) -> None:
    ...
    constants = {
        ...
        "IRQ_FLAG_RTC": 1,
        "IRQ_FLAG_SAVE_FLUSH": 2,
        "IRQ_FLAG_SAVE_FLUSH_AUTO": 4,
        "IRQ_FLAG_SAVE_FLUSH_HOTKEY": 8,
        ...
        "IRQ_SAVE_FLUSH_ENTRY_OFFSET": symbols["irq_save_flush_entry"],
