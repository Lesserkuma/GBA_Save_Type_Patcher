...
export const GBA_RESERVED_ROM_TAIL_SIZE_BYTES = 0x100;
export const GBA_PAYLOAD_PLACEMENT_LIMIT_BYTES = GBA_MAX_ROM_SIZE_BYTES
  - GBA_RESERVED_ROM_TAIL_SIZE_BYTES;
