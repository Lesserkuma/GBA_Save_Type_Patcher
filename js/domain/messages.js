...
export const UI_TEXT = Object.freeze({
  ...
  SAVE_FILES_CACHED: "Save file(s) cached for embedding or conversion.",
...
export const uiMessage = Object.freeze({
  ...
  directEepromSaveSize: (name) => `${name}: Direct EEPROM saves must be 512, 8192, 65536, or 131072 bytes.`,
  directSramSaveSize: (name) => `${name}: Direct SRAM saves must be 32768, 65536, or 131072 bytes.`,
  directPhysicalSaveSize: (name) => `${name}: Direct physical saves must be 65536 or 131072 bytes.`,
